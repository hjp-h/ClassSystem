...
<link rel="stylesheet" type="text/css" href="static/css/stulogin.css">
...
<div id="stuloginContainer">
	<div class="login_box">  
	    <div id="stulogin">
	        <h4>学生登录</h4>
	    </div>    
		<form class="form-inline" action="${pageContext.request.contextPath}/studentLoginCheck" method="post">
			 <div class="form-group f1">
			 	<label for="exampleInputName1">账&nbsp;&nbsp;&nbsp;&nbsp;号</label>
				<input name="stuNo" type="text" class="form-control" id="exampleInputName1" placeholder="你的账号">
			</div><br>
			<div class="form-group password f2" style="margin-top:5px;">
				<label for="exampleInputPassword3">密&nbsp;&nbsp;&nbsp;&nbsp;码</label>
				<input name="stuPwd" type="password" class="form-control" id="exampleInputPassword3" placeholder="密码">
				</div><br>
