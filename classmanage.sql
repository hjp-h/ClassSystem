...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', '181543148', '张小三', '1234', '181543148.jpg', 'admin');
INSERT INTO `admin` VALUES ('6', '181543147', '李小四', '1234', '181543147.jpg', 'admin');
...
CREATE TABLE `admin_role` (
  ...
  `admin_no` varchar(9) NOT NULL,
  `role_id` int(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_admin_no` (`admin_no`),
  KEY `fk_role_id` (`role_id`),
  CONSTRAINT `fk_admin_no` FOREIGN KEY (`admin_no`) REFERENCES `admin` (`admin_no`),
...
-- ----------------------------
INSERT INTO `admin_role` VALUES ('1', '181543148', '1');
INSERT INTO `admin_role` VALUES ('2', '181543147', '2');
...
INSERT INTO `course_record` VALUES ('2', '18', '2', '1');
...
INSERT INTO `course_record` VALUES ('25', '14', '5', '1');
INSERT INTO `course_record` VALUES ('26', '14', '6', '1');
INSERT INTO `course_record` VALUES ('27', '17', '1', '7');
...
-- Records of perm
-- ----------------------------
INSERT INTO `perm` VALUES ('1', '1', 'admin_all');
INSERT INTO `perm` VALUES ('2', '2', 'teacher_all');
INSERT INTO `perm` VALUES ('3', '3', 'class:add');
INSERT INTO `perm` VALUES ('4', '4', 'class:update');
INSERT INTO `perm` VALUES ('5', '5', 'class:delete');
INSERT INTO `perm` VALUES ('6', '6', 'class:query');
INSERT INTO `perm` VALUES ('7', '7', 'stu:add');
INSERT INTO `perm` VALUES ('8', '8', 'stu:update');
INSERT INTO `perm` VALUES ('9', '9', 'stu:delete');
INSERT INTO `perm` VALUES ('10', '10', 'stu:query');
...
INSERT INTO `role` VALUES ('2', '2', 'teacher');
...
CREATE TABLE `role_perm` (
  ...
  CONSTRAINT `fk_perm_id2` FOREIGN KEY (`perm_id`) REFERENCES `perm` (`perm_id`),
  CONSTRAINT `fk_role_id2` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`)
...
INSERT INTO `role_perm` VALUES ('11', '2', '6');
INSERT INTO `role_perm` VALUES ('12', '2', '7');
INSERT INTO `role_perm` VALUES ('13', '2', '8');
INSERT INTO `role_perm` VALUES ('14', '2', '9');
INSERT INTO `role_perm` VALUES ('15', '2', '10');
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES ('1', '123456789', '张标啊', '1234', '1234.jpg', 'M', '15512345678', '15512345678@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('2', '123456788', '刘禹熹', '1234', '1233.jpg', 'M', '15512345677', '15512345677@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('3', '123456787', '刘芳', '1234', '1232.jpg', 'F', '15512345676', '15512345676@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('4', '123456786', '张三', '1234', '', 'F', '15512345675', '15512345675@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('5', '123456785', '李四', '1234', null, 'M', '15512345674', '15512345674@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('6', '123456784', '王五', '1234', null, 'F', '15512345673', '15512345673@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('7', '123456783', '赵六', '1234', null, 'F', '15512345672', '15512345672@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('8', '123456782', '巴巴', '1234', null, 'M', '15512345671', '15512345671@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('9', '123456781', '九九', '1234', null, 'F', '15512345669', '15512345669@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('10', '123456780', '时时', '1234', null, 'F', '15512345668', '15512345668@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('11', '123456779', '一一', '1234', null, 'M', '15512345667', '15512345667@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('12', '123456778', '十二', '1234', null, 'M', '15512345666', '15512345666@qq.com', 'Y');
INSERT INTO `teacher` VALUES ('14', '123456754', '寒冬', null, null, null, null, null, 'N');
INSERT INTO `teacher` VALUES ('17', '123456765', '鲜征征', null, null, 'F', '15521044544', 'xianzhengzheng@qq.com', 'N');
INSERT INTO `teacher` VALUES ('18', '123451234', '丘成峰', '00000000', null, 'M', '15521044544', '1399375290@qq.com', 'N');
